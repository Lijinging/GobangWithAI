...
public class ChessBoard extends JPanel implements MouseListener {
   ...
   chessPoint[][] chessmap= new chessPoint[ROWS+1][COLS+1];
...
//绘制
   ...
   public chessSituation DconintueN(int direct, int xIndex, int yIndex, Color c)
   {
	   //direct 0:水平 1:垂直 3:左下-右上 4：右下-左上
	   chessSituation s = new chessSituation();
	   switch(direct){
	   case 0:{
